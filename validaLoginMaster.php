...
$id_usuario = isset($_POST['id_usuarioAC']) ? $_POST['id_usuarioAC'] : '';
$nombredelusuario = isset($_POST['nombredelusuarioAC']) ? $_POST['nombredelusuarioAC'] : '';
$noEmpleado = isset($_POST['noEmpleadoAC']) ? $_POST['noEmpleadoAC'] : '';
$rol = isset($_POST['rolAC']) ? $_POST['rolAC'] : '';
$usuario = isset($_POST['correoAC']) ? $_POST['correoAC'] : '';
